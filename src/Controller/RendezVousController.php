...
final class RendezVousController extends AbstractController
{
    ...
    public function backindex(Request $request, RendezVousRepository $rendezVousRepository): Response
    {
        ...
        return $this->render('rd/rendez_vous_back/index.html.twig', [
    ...
    public function backnew(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('rd/rendez_vous_back/new.html.twig', [
    ...
    public function index(Request $request, RendezVousRepository $rendezVousRepository): Response
    {
        ...
        return $this->render('rd/rendez_vous/index.html.twig', [
            'rendez_vouses' => $rendezVouses,
            'query' => $query,
        ]);
    }

    #[Route('/new', name: 'app_rendezvous_front', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager, MailerInterface $mailer): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_front_rdv');
        }

        return $this->render('rd/rendez_vous/new.html.twig', [
            'rendez_vou' => $rendezVou,
    ...
    public function recherche(Request $request, RendezVousRepository $repository): Response
    {
        ...
        if ($request->isXmlHttpRequest()) {
            return $this->render('rd/rendez_vous_back/search.html.twig', [
                'rendez_vouses' => $rendezVouses,
                'query' => $query,
            ]);
        }
    ...
    public function generatePdf(RendezVousRepository $rendezVousRepository, PdfGenerator $pdfGenerator): Response
    {
        ...
        $htmlContent = $this->renderView('rd/rendez_vous_back/pdf.html.twig', [
            'rendez_vouses' => $rendezVouses,
        ]);
    ...
    {
        return $this->render('rd/rendez_vous_back/show.html.twig', [
            'rendez_vou' => $rendezVou,
        ]);
    }
    ...
    public function backedit(Request $request, RendezVous $rendezVou, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('rd/rendez_vous_back/edit.html.twig', [
            'rendez_vou' => $rendezVou,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('rd/rendez_vous/show.html.twig', [
            'rendez_vou' => $rendezVou,
        ]);
    }
    ...
    public function edit(Request $request, RendezVous $rendezVou, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('rd/rendez_vous/edit.html.twig', [
            'rendez_vou' => $rendezVou,
            'form' => $form,
        ]);
    }
