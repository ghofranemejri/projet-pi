...
final class ReponseController extends AbstractController
{
    ...
    {
        return $this->render('form/reponse/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('form/reponse/new.html.twig', [
            'reponse' => $reponse,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('form/reponse/show.html.twig', [
            'reponse' => $reponse,
        ]);
    }
    ...
    public function edit(Request $request, Reponse $reponse, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('form/reponse/edit.html.twig', [
            'reponse' => $reponse,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('form/reponse_back/index.html.twig', [
            'reponses' => $reponseRepository->findAll(),
        ]);
    }
...
public function newback(Request $request, EntityManagerInterface $entityManager): Response
{
    ...
    return $this->render('form/reponse_back/new.html.twig', [
        'reponse' => $reponse,
        'form' => $form,
    ]);
}
    ...
    {
        return $this->render('form/reponse_back/show.html.twig', [
    ...
    public function editBack(Request $request, Reponse $reponse, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('form/reponse_back/edit.html.twig', [
            'reponse_back' => $reponse,
            'form' => $form,
        ]);
    }
