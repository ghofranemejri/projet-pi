...
#[Route('/form/post')]
    ...
    ->getQuery();
        ...
        return $this->render('form/form_post/index.html.twig', [
            'pagination' => $pagination,
        ]);
    }

    #[Route('/back/form', name: 'app_form_back_index', methods: ['GET'])]
    public function backindex(FormPostRepository $formPostRepository, PaginatorInterface $paginator, Request $request): Response
    {
        ...
        return $this->render('form/form_back/index.html.twig', [
            'pagination' => $pagination,
        ]);
    }
...

    {
        ...
        return $this->render('form/form_post/new.html.twig', [
            'form_post' => $formPost,
    ...
    public function backNew(Request $request, EntityManagerInterface $entityManage, BadWordFilter $badWordFilter): Response
    {
        $formPost = new FormPost();
        $form = $this->createForm(FormPostType::class, $formPost);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            if ($badWordFilter->containsBadWords($formPost->getDescription())) {
                $this->addFlash('danger', 'Votre description contient des mots interdits.');
                return $this->redirectToRoute('app_form_back_new');
            }
        ...
        return $this->render('form/form_back/new.html.twig', [
            'form_post' => $formPost,
            'form' => $form->createView(),
        ]);
    }
    ...
    public function edit(Request $request, FormPost $formPost, EntityManagerInterface $entityManager, BadWordFilter $badWordFilter): Response
    {
        $form = $this->createForm(FormPostType::class, $formPost);
        $form->handleRequest($request);
        ...
        return $this->render('form/form_post/edit.html.twig', [
            'form_post' => $formPost,
            'form' => $form->createView(),
        ]);
    }
    ...
    public function backEdit(Request $request, FormPost $formPost, EntityManagerInterface $entityManager, BadWordFilter $badWordFilter): Response
    {
        $form = $this->createForm(FormPostType::class, $formPost);
        $form->handleRequest($request);
        ...
        return $this->render('form/form_back/edit.html.twig', [
            'form_post' => $formPost,
            'form' => $form->createView(),
        ]);
    }
...
public function search(Request $request, FormPostRepository $formPostRepository): Response
{
    ...
    return $this->render('form/form_post/search.html.twig', [
        'form_posts' => $formPosts,
        'query' => $query,
    ]);
}
