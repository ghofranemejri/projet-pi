...
class PrescriptionController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $prescription->setMedecin($entityManager->getRepository(\App\Entity\Utilisateur::class)->find(self::MEDECIN_ID));
    ...
    {
        if ($prescription->getMedecin()->getId() !== self::MEDECIN_ID) {
            throw $this->createAccessDeniedException('Vous ne pouvez supprimer que vos propres prescriptions.');
        }
    ...
    public function showPrescriptions(
        ...
        $prescriptions = $prescriptionRepository->findBy(['patient' => self::PATIENT_ID]);
    ...
    public function calendar(): Response
    {
        ...
        return $this->render('prescription/calendar.html.twig', [
            'userId' => $staticUserId,
        ]);
    }
