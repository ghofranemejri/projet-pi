...
class MessagingControllerBack extends AbstractController
{
    private $security;
    ...
    #[Route('/admin', name: 'messenger_admin', methods: ['GET'])]
    public function index(EntityManagerInterface $em, UserRepository $userRepo): Response
    {
        ...
        return $this->render('form/form_post/messback.html.twig', [
            'currentUser' => $currentUser,
            'admin' => $admin,
        ]);
    }

    #[Route('/sendadmin', name: 'send_message_admin', methods: ['POST'])]
    ...
    #[Route('/messagesadmin', name: 'fetch_messages_admin', methods: ['GET'])]
